<div class="grid grid-cols-1 items-center w-full h-auto gap-4 py-8" x-data="{ isDropping: false, isUploading: false, progress: 0 }"
   ...
   <hr class="h-px w-full border-none bg-base-300">
    ...
    @if (isset($adminlogo) && $adminlogo != '')
        <div class="relative w-3/4 border border-dashed border-base-300 rounded-lg">
        ...
        <div class="flex-1">
            ...
            <div class="" :class="{ 'border-primary bg-primary/5': isDropping }"
                ...
                <label for="file-upload"
                    class="relative flex justify-center items-center cursor-pointer rounded-lg aspect-video w-3/4 border border-dashed border-gray-900/25 hover:border-primary px-6 py-10 transition-colors duration-200">
            ...
            <!-- Progress Bar -->
            <div x-show="isUploading" class="w-3/4 bg-gray-200 rounded-full h-2.5 mt-2" x-cloak>
