<div x-data="{
    ...
    <div class="flex gap-4 items-center pb-4">
        ...
        <div class="flex items-center gap-4 py-2 w-full justify-end">
            <div class="w-48">
                <x-kompass::select id="filter-type" :searchable="false" wire:model.live="filter" label="{{ __('Filter by Type') }}" :options="[
                    ['name' => __('All'), 'id' => ''],
    ...
    @if ($folders->isNotEmpty())
        ...
        <div class="mb-6">
            <div class="flex items-center gap-2 mb-3">
                <span class="text-sm font-semibold opacity-60 mb-2">{{ __('Folders') }} ({{ $folders->count() }})</span>
            </div>
            <div class="@container">
    ...
    @elseif ($files->isNotEmpty())
        @if ($folders->isNotEmpty())
            ...
            <div class="flex items-center gap-2 mb-3">
                <span class="text-sm font-semibold opacity-60 mb-2">{{ __('Assets') }} ({{ $files->total() }})</span>
