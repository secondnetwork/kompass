...
<div x-show="open"  class="flex flex-col right-0 {{$w ?? 'w-3/4'}}  fixed top-0 py-4 bg-base-100  h-full overflow-auto z-40 shadow"
    ...
    <div x-show="open" class="absolute inset-0 flex flex-col ">
        ...
        <div class="body-content p-8 pt-4 grid gap-4">
            ...
            <span>
              ...
              <span @click="open = false" class=" cursor-pointer p-2 bg-base-200 rounded-full hover:bg-base-300 transition-all"><x-tabler-x /></span>
            </span>
