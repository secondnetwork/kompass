    ...
    <div class="hero min-h-screen">
        <div class="hero-content flex-col lg:flex-row-reverse items-center">
            ...
            <div class="max-w-md text-center lg:text-left">
                <h1 class="text-5xl font-bold text-warning">419</h1>
                <p class="py-6 text-2xl font-semibold">Page Expired.</p>
                <p class="text-lg text-base-content/70">Your session has expired. Please refresh and try again.</p>
                <div class="mt-8">
                    <a href="{{ url('/') }}" class="btn btn-primary">Go to Homepage</a>
                    <button onclick="location.reload()" class="btn btn-ghost ml-4">Refresh Page</button>
                </div>
            </div>
        </div>
    </div>
