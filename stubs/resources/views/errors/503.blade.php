    ...
    <div class="hero min-h-screen">
        <div class="hero-content flex-col lg:flex-row-reverse items-center">
            ...
            <div class="max-w-md text-center lg:text-left">
                <h1 class="text-5xl font-bold text-warning">503</h1>
                <p class="py-6 text-2xl font-semibold">Service Unavailable.</p>
                <p class="text-lg text-base-content/70">The server is temporarily unable to handle the request. This may be due to maintenance or overloading.</p>
                <div class="mt-8">
