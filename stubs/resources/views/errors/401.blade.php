    ...
    <div class="hero min-h-screen">
        <div class="hero-content flex-col lg:flex-row-reverse items-center">
            ...
            <div class="max-w-md text-center lg:text-left">
                <h1 class="text-5xl font-bold text-error">401</h1>
                <p class="py-6 text-2xl font-semibold">Unauthorized.</p>
                <p class="text-lg text-base-content/70">You are not authorized to access this page.</p>
                <div class="mt-8">
