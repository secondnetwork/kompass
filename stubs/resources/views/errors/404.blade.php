    ...
    <div class="hero min-h-screen">
        <div class="hero-content flex-col lg:flex-row-reverse items-center">
            ...
            <div class="max-w-md text-center lg:text-left">
                ...
                <p class="py-6 text-2xl font-semibold">Oops! Page not found.</p>
                <p class="text-lg text-base-content/70">The page you are looking for might have been removed, had its name changed or is temporarily unavailable.</p>
                <div class="mt-8">
